...
class Registration extends Component {
    ...
    componentWillMount() {
        axios.get("http://localhost:8080/getAllRole")
           ...
           console.log("NEW USER=",sessionStorage.getItem("NewUser"))
            axios.get("http://localhost:8080/getUserDetail/"+sessionStorage.getItem("NewUser"))
            .then(response => {
    ...
    handleSubmitSignUp(e) {
        ...
        const data = {
            ...
            userId:sessionStorage.getItem("NewUser"),
                        ...
                        <Row>
                            <Col lg={12}>
                                ...
                                <Row>
                                    ...
                                    <Col lg={2}>
                                        <FormGroup>
                                            <select type="select" id="roleId" name="roleId" onChange={this.handleChange} value={this.state.roleId} className="FormField_select" disabled required style={style}>
